    ...
    >
      <View style={styles.list}>
          ...
          { properties && properties.length > 0 ? 
            properties.sort((a, b) => a.auctionDate - b.auctionDate).map(property => <PropertyCard style={styles.card} key={property.id} property={property} onPress={() => onPropertyPress(property.id)} onRefresh={onRefresh}/>) 
          : null }
      </View>
    </ScrollView>
  )
